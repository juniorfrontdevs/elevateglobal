const themeToggle=document.getElementById("themeToggle");const languageDropdown=document.querySelector(".language-dropdown");const languageToggle=document.querySelector(".language-toggle");const languageMenu=document.querySelector(".language-menu");const signupForm=document.getElementById("signupForm");const passwordInput=document.getElementById("passwordInput");const confirmPasswordInput=document.getElementById("confirmPasswordInput");if(localStorage.getItem("egm-theme")==="light"){document.body.classList.add("light");themeToggle.innerHTML='<i class="fa-solid fa-sun"></i>'}themeToggle.addEventListener("click",()=>{document.body.classList.toggle("light");const l=document.body.classList.contains("light");themeToggle.innerHTML=l?'<i class="fa-solid fa-sun"></i>':'<i class="fa-solid fa-moon"></i>';localStorage.setItem("egm-theme",l?"light":"dark")});languageToggle.addEventListener("click",e=>{e.stopPropagation();const open=languageDropdown.classList.toggle("open");languageToggle.setAttribute("aria-expanded",String(open));languageMenu.hidden=!open});document.addEventListener("click",e=>{if(!languageDropdown.contains(e.target)){languageDropdown.classList.remove("open");languageToggle.setAttribute("aria-expanded","false");languageMenu.hidden=true}});signupForm.addEventListener("submit",e=>{e.preventDefault();if(passwordInput.value!==confirmPasswordInput.value){alert("Passwords do not match.");return}alert("Registration form submitted!")});
